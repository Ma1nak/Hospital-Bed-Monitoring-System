...
--
-- Host: localhost
-- Generation Time: Jan 16, 2014 at 05:35 PM
...
(1, 7, 45, 'aa', 'aa', 'aa', 'aa@.', 2147483647, 'qq', 'ww');
...
INSERT INTO `patient` (`PATIENT_ID`, `FNAME`, `MNAME`, `LNAME`, `DEPARTMENT`, `EMAIL`, `CONTACTNO`, `USERID`, `PASSWORD`, `DOCTOR_ID`, `NURSE_ID`) VALUES
(3, 'Arunabha', '', 'Bhaumik', 'Cardiology', 'aa@yahoo.in', 2147483647, '', '', 'pending', 'pending'),
(7, 'Mainak', '', 'Maulik', 'Dermatology', 'mm@hotmail.in', 8972072151, '', '', 'pending', 'pending'),
(8, 'ff', 'g', 'hh', 'Dermatology', '', 987654322, '', '', 'pending', 'pending'),
(20, 'dfsdf', '', 'ad', 'Cardiology', '', 1233333333, '', '', 'pending', 'pending'),
(21, 'dfsdf', '', 'ad', 'Cardiology', '', 1233333333, '', '', 'pending', 'pending'),
(22, 'dfsdf', '', 'qeqwe', 'Cardiology', '', 3456543456, '', '', 'pending', 'pending'),
(23, 'dfsdf', '', 'qeqwe', 'Cardiology', '', 3456543456, '', '', 'pending', 'pending'),
(24, 'dfsdf', '', 'qeqwe', 'Cardiology', '', 3456543456, '', '', 'pending', 'pending'),
(26, 'dfsdf', '', 'qeqwe', 'Cardiology', '', 3456543456, '', '', 'pending', 'pending'),
(27, 'dfsdf', '', 'qeqwe', 'Cardiology', '', 3456543456, '', '', 'pending', 'pending'),
(28, 'dfsdf', 'afsadf', 'ad', 'Cardiology', '', 3456543456, '', '', 'pending', 'pending'),
(43, 'raj', 'ee', 'aa', 'Dermatology', '', 1111111111, '', '', 'pending', 'pending'),
(44, 'dfsdf', 'afsadf', 'qeqwe', 'Cardiology', '', 3456543456, '', '', 'pending', 'pending'),
(45, 'dfsdf', 'afsadf', 'qeqwe', 'Cardiology', '', 3456543456, 'eee', 'aaa', '4', '1'),
(46, 'dfsdf', 'afsadf', 'ad', 'Dermatology', 'aaa@gmail.com', 3456543456, 'eee', 'aaaa', 'pending', 'pending'),
(47, 'arer', '', 'werw', 'Cardiology', '', 2222222222, 'aaa', 'aaa', 'pending', 'pending');
...
INSERT INTO `requestpatient` (`REQUEST_ID`, `PATIENT_ID`) VALUES
(1, 45);
